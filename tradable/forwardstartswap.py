...
class ForwardStartSwap(ITradable):
    ...
    def name(self):
        return 'ForwardStartSwap' + self.currency + self.expiration.isoformat() + self.tenor + format_number(self.strike, 8) + self.style
