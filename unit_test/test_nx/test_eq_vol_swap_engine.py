...
class Test(unittest.TestCase):
    ...
    def test_eq_vol_swap_engine(self):
        ...
        pricing_engine = NxEqVolSwapEngine.make(self.valuationTimePoint, {self.underlyingPricingID: fit_results}, fixings)

        vol_swap = self.build_vol_swap()
        vol_swap.setPricingEngine(pricing_engine)
        r = vol_swap.calculateAllResults()
        val = r.getResult('PV')
        self.assertEqual(val, -7.16881918499499)
