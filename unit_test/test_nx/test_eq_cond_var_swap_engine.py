...
class Test(unittest.TestCase):
    def setUp(self):
        ...
        self.barrierCondition = "bcTandTMinusOneConvention"
        self.barrierType = "UpVar"
        self.downVarBarrier = 1000000000
        self.upVarBarrier = 2000
        self.lag = 1
        self.cap = 0.
    ...
    def test_eq_vol_swap_engine(self):
        ...
        pricing_engine = NxEqCondVarSwapEngine.make(self.valuationTimePoint, {self.underlyingPricingID: fit_results}, fixings)

        cond_var_swap = self.build_cond_var_swap()
        cond_var_swap.setPricingEngine(pricing_engine)
        r = cond_var_swap.calculateAllResults()
        val = r.getResult('PV')
        self.assertEqual(-239.25762657668338, val)
