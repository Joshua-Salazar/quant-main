from ctp.instruments.swaps import FxVolSwap
...
class FXVolSwapNxValuer(FXNxValuer):
    def __init__(self, *args, **kwargs):
        super(FXVolSwapNxValuer, self).__init__(*args, **kwargs)

    @staticmethod
    def build_trade(vol_swap: VolSwap, underlying_id: str):
        ...
        swap = FxVolSwap.make(
            ...
            currencyPair=CurrencyPair(getCurrency(vol_swap.underlying[:3]), getCurrency(vol_swap.underlying[3:])),
    ...
    def ask_keys(self, var_swap: VolSwap, market: Market=None, **kwargs):
        keys = []
        # add vol surface
