    ...
    def execute(self, state: StrategyState):
        ...
        if portfolio.is_empty():
            ...
            for leg_name, leg_params in self.parameters['legs'].items():
                ...
                current_future = self.parameters['roll'][leg_name].find_target_contract(self.time_stamp, target_tenor = self.parameters['legs'][leg_name][ 'target_future' ], root = self.parameters['legs'][leg_name][ 'underlying' ], skip_months = skip_months )
            ...
            for leg_name, leg_params in self.parameters['legs'].items():
                ...
                self.parameters['roll'][leg_name].roll_to_target(self.time_stamp, leg_portfolio, target_tenor = self.parameters['legs'][leg_name][ 'target_future' ], skip_months = skip_months)
